...
\begin{enumerate}
    \item \orange{数据}
          \begin{itemize}
              \item data, props, propsData, computed, methods, watch
          \end{itemize}
    \item \orange{DOM}
          \begin{itemize}
              \item el, template, render, renderError
          \end{itemize}
    \item \orange{生命周期钩子}
          \begin{itemize}
              \item beforeCreate, created, beforeMount, mount, beforeUpdate, updated
              \item activated, deactivated, beforeDestroy, destroyed, errorCaptured
          \end{itemize}
    \item \orange{资源}
          \begin{itemize}
              \item directives, filters, components
          \end{itemize}
    \item \orange{组合}
          \begin{itemize}
              \item parent, mixins, extends, provide, inject
          \end{itemize}
\end{enumerate}
\subsubsection{属性分段}
\subsubsection{入门属性}
\subsection{el和data选项}
\subsection{methods, components, 四个钩子}
\subsection{props}
\section{数据响应式}
