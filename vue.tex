...
\begin{enumerate}
    \item \orange{场景描述}
          \begin{itemize}
              \item 爸爸给儿子钱，儿子要花钱怎么办 \quad\tiffany{\underline{\href{https://github.com/syuancao/FrontNotePractice/blob/master/VUE/vue-model/index2.html}{代码示例}}}
    ...
    \item \orange{由于这种场景很场景}
          \begin{itemize}
              ...
              \item :money=``total''v-0:update:money=``total=\$event''
          \end{itemize}
\end{enumerate}
