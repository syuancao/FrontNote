...
\red{彩虹demo}
\p
\tiffany{\underline{\href{https://syuancao.github.io/FrontNotePractice/CSS/rainbow/index.html}{预览地址}}}
\p
\yellow{\underline{\href{https://github.com/syuancao/FrontNotePractice/tree/master/CSS/rainbow}{代码地址}}}
\subsection{布局}
\red{布局就是把页面分成一块一块，按左中右，上中下等排列}
\subsubsection{布局分类}
\begin{enumerate}
    \item \orange{两种}
          \begin{itemize}
...
\begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
    \centering %图片居中
    \includegraphics[width=0.7\textwidth]{image/onepic.png} %插入图片，[]中设置图片大小，{}中是图片文件名
    \caption{一图流} %最终文档中希望显示的图片标题
\end{figure}
\begin{enumerate}
    \item \orange{float布局}
          \begin{itemize}
...
\begin{enumerate}
    ...
    \item \orange{实践经验}
          \begin{itemize}
              ...
              \item float用来应付IE足矣
              \item \tiffany{\underline{\href{https://syuancao.github.io/FrontNotePractice/CSS/floatLayout/index.html}{预览地址}}}
              \item \yellow{\underline{\href{https://github.com/syuancao/FrontNotePractice/tree/master/CSS/floatLayout}{代码地址}}}
          \end{itemize}
\end{enumerate}
...
\begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
    \centering %图片居中
    \includegraphics[width=0.7\textwidth]{image/container.png} %插入图片，[]中设置图片大小，{}中是图片文件名
    \caption{容器container} %最终文档中希望显示的图片标题
\end{figure}
\begin{enumerate}
    \item \orange{flex container 有哪些样式}
          \begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
              \centering %图片居中
              \includegraphics[width=0.7\textwidth]{image/flexcontainer.png} %插入图片，[]中设置图片大小，{}中是图片文件名
              \caption{让一个元素变成flex容器} %最终文档中希望显示的图片标题
          \end{figure}
          \begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
              \centering %图片居中
              \includegraphics[width=0.7\textwidth]{image/flexdirection.png} %插入图片，[]中设置图片大小，{}中是图片文件名
              \caption{改变items流动方向(主轴)} %最终文档中希望显示的图片标题
          \end{figure}
          \begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
              \centering %图片居中
              \includegraphics[width=0.7\textwidth]{image/flexwrap.png} %插入图片，[]中设置图片大小，{}中是图片文件名
              \caption{改变折行} %最终文档中希望显示的图片标题
          \end{figure}
          \begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
              \centering %图片居中
              \includegraphics[width=0.7\textwidth]{image/flexstart.png} %插入图片，[]中设置图片大小，{}中是图片文件名
              \caption{主轴对齐方式} %最终文档中希望显示的图片标题
          \end{figure}
          \begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
              \centering %图片居中
              \includegraphics[width=0.7\textwidth]{image/flexend.png} %插入图片，[]中设置图片大小，{}中是图片文件名
              \caption{次轴对齐} %最终文档中希望显示的图片标题
          \end{figure}
          \begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
              \centering %图片居中
              \includegraphics[width=0.7\textwidth]{image/flexline.png} %插入图片，[]中设置图片大小，{}中是图片文件名
              \caption{多行内容} %最终文档中希望显示的图片标题
          \end{figure}
    \item \orange{flex container 有哪些属性}
          \begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
              \centering %图片居中
              \includegraphics[width=0.7\textwidth]{image/itemorder.png} %插入图片，[]中设置图片大小，{}中是图片文件名
              \caption{item上面加order} %最终文档中希望显示的图片标题
          \end{figure}
          \begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
              \centering %图片居中
              \includegraphics[width=0.7\textwidth]{image/flexgrow.png} %插入图片，[]中设置图片大小，{}中是图片文件名
              \caption{item上面加flex-grow} %最终文档中希望显示的图片标题
          \end{figure}
          \begin{itemize}
              \item flex-shrink控制如何变瘦
              \item \orange{一般写flex-shrink:0防止变瘦，默认是1}
              \item flex-basis控制基准宽度
              \item \orange{默认是auto}
          ...
          \begin{figure}[H] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
              \centering %图片居中
              \includegraphics[width=0.7\textwidth]{image/alignself.png} %插入图片，[]中设置图片大小，{}中是图片文件名
              \caption{align-self定制align-items} %最终文档中希望显示的图片标题
          \end{figure}
    \item \orange{重点:工作中基本只用这些}
          \begin{itemize}
              \item display：flex
    ...
    \item \orange{实践:不同布局}
          \begin{itemize}
              ...
              \item \tiffany{\underline{\href{https://syuancao.github.io/FrontNotePractice/CSS/floatLayout/index.html}{预览地址}}}
              \item \yellow{\underline{\href{https://github.com/syuancao/FrontNotePractice/tree/master/CSS/flexLayout}{代码地址}}}
          \end{itemize}
    \item \orange{经验}
          \begin{itemize}
